...
if (isset($_GET['delete'])) {
  $sql = "DELETE FROM student WHERE sid='" . $_GET['delete'] . "'";
  $conn->query($sql);
  # code...
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        ...
        <div class="row">
          ...
          <?php if (!isset($_GET['update']) && !isset($_GET['details']) && !isset($_GET['delete']) ) { ?>
            <div class="col-xs-4">
              ...
              <div class="box box-primary">
                ...
                <form role="form" method="POST">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <label for="exampleInputPassword1">Student ID (Unique and can not change)</label>
                ...
                if (isset($_POST['submit'])) {
                  ...
                  try {
                    ...
                    $sql = "INSERT INTO student (sid,fname,lname,bday,address,gender,email) VALUES ('" . $sid . "', '" . $fname . "', '" . $lname . "','" . $dob . "','" . $address . "','" . $gender . "','" . $email . "')";
                    ...
                    echo "<script> alert('Information duplicated! Try again') </script>";
                  }
                }
                ?>
              </div>
              ...
              <div class="box box-primary">
                ...
                if (isset($_POST['submit'])) {
                  ...
                  try {
                    ...
                    $sql = "UPDATE student set fname='" . $fname . "',lname='" . $lname . "',bday='" . $dob . "',address='" . $address . "',gender='" . $gender . "',email='" . $email . "' where sid='" . $sid . "'";
                    ...
                    if ($result->num_rows > 0) {
                      ...
                      while ($row = $result->fetch_assoc()) {
                        echo "<tr><td> " . $row["sid"] . " </td><td> " .
                          ...
                          "<a href='student.php?details=" . $row["sid"] . "'><small class='label  bg-green'>Details</small></a>" .
                          "<a href='student.php?update=" . $row["sid"] . "'><small class='label  bg-orange'>Update</small></a>" .
                          "<a href='student.php?delete=" . $row["sid"] . "'><small class='label  bg-red'>Delete</small></a>";
                      }
                    }
